...
class Image implements CaptchaInterface {
    ...
    public function __construct($imageDir, $imageUrl, $imageFont = null, $label = null, $length = null,
        $includeNumbers = true, $includeUpper = true, $includeLower = true, $includeSpecial = false, $otherChars = null,
        ...
        try {
            ...
            for ($i = 0; $i < $max; $i++) {
                if ($this->imageFont) {
                    ...
                    if ($count++ & 1) imagechar($im, 5, $x, $y, $phrase[$i], $black);
                    else imagecharup($im, 5, $x, $y, $phrase[$i], $black);
                }
                $x += (int) ($size * 1.2);
            }
            $numDots = rand(10, 999);
